...
export function RetroGrid({
  ...
  useEffect(() => {
    ...
    const draw = (timestamp: number) => {
      if (currentWidth === 0 || currentHeight === 0 || !gl || !positionBuffer || !programInfo || isContextLost) {
        return;
      }
