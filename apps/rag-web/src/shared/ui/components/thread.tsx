...
import { ToolFallback } from "@/shared/ui/components/tool-fallback";
import { TooltipIconButton } from "@/shared/ui/components/tooltip-icon-button";
...
export const Thread: FC = () => {
  return (
    ...
    >
      ...
      >
        <div className="mx-auto flex w-full max-w-(--thread-max-width) flex-col px-4 pt-4 min-h-0 h-full">
...
const ThreadWelcome: FC = () => {
  return (
    <div className="aui-thread-welcome-root flex flex-col mt-4">
      <div className="aui-thread-welcome-center flex w-full flex-col items-start">
        <div className="aui-thread-welcome-message flex w-full flex-col px-4">
